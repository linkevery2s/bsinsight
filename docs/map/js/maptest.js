...
function geo_st(feature, layer) {
	...
	popup += '<iframe width="100%" height="250" frameborder="0" style="border:0" src="https://www.google.com/maps/embed/v1/directions?key=AIzaSyDjVsh3kIgbxo0GpbLSq9v0VNnw6q611Mk&origin=35.35581,136.77187&destination=' + feature.properties.la + "," + feature.properties.ln + '&maptype=roadmap" allowfullscreen></iframe>';
...
//document.getElementById("rt").innerHTML = '<iframe width="100%" height="250" frameborder="0" style="border:0" src="https://www.google.com/maps/embed/v1/directions?key=AIzaSyDjVsh3kIgbxo0GpbLSq9v0VNnw6q611Mk&origin=35.35581,136.77187&destination=' + feature.properties.la + "," + feature.properties.ln + '&maptype=roadmap" allowfullscreen></iframe>';

document.getElementById("rt").innerHTML = '<iframe width="100%" height="250" frameborder="0" style="border:0" src="https://www.google.com/maps/embed/v1/directions?key=AIzaSyDjVsh3kIgbxo0GpbLSq9v0VNnw6q611Mk&origin=35.35581,136.77187&destination=35.25581,136.77187&maptype=roadmap" allowfullscreen></iframe>';
