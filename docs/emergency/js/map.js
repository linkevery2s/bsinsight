...
var todou = "" ;var ido; var keido; var hash;var back_b; var t0, t1, t2, t3, t4, t5, t6, t7; var baseMaps; var cont = "";
...
function rn(){
	...
	if(cont === ""){
		...
		cont.remove();
		t0.remove();t1.remove();t2.remove();t3.remove();t4.remove();t5.remove();t6.remove();t7.remove();
		}
		
		todou = L.geoJson(x, {style: sty,onEachFeature: geo_k, pointToLayer: iro}).addTo(map);
		map.fitBounds(todou.getBounds());
		t0 = new L.tileLayer('https://disaportaldata.gsi.go.jp/raster/01_flood_l2_shinsuishin_kuni_data/{z}/{x}/{y}.png', {opacity: 0.8});
